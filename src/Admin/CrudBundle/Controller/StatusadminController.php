...
use Demos\BlogBundle\Entity\Status;
use Admin\CrudBundle\Form\StatusType;
...
class StatusadminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DemosBlogBundle:Status')->findAll();
     ...
     * @Method("POST")
     * @Template("AdminCrudBundle:Status:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DemosBlogBundle:Status')->find($id);
    ...
    */
     ...
     * @Method("POST")
     * @Template("AdminCrudBundle:Status:edit.html.twig")
     */
     ...
     *
     * @Route("/status_delete/{id}", name="status_delete")
     * @Method("POST")
     */
