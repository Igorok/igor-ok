...
use Admin\CrudBundle\Form\NewsType;
...
class NewsadminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DemosBlogBundle:News')->findAll();
     ...
     * @Method("POST")
     * @Template("AdminCrudBundle:News:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DemosBlogBundle:News')->find($id);
    ...
    */
     ...
     * @Method("POST")
     * @Template("AdminCrudBundle:News:edit.html.twig")
     */
